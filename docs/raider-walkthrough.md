...
- Submitting records the find for the officers and posts the familiar bot-style message to the BoE Discord channel; officers handle listing, sale, and payout from the BoE Sales section of the guild page ([#774](https://github.com/katogaming88/WGA-Raid-Hub/issues/774)), which raiders never see
