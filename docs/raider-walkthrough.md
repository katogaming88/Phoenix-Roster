...
- Hidden per team via the `boe` feature flag (Admin tab / site admin dashboard): a team with it off drops out of the reporting dropdown, and the **BoE** nav item disappears from that team's page
