...
| **BoE Sales** | -- | Not a tab any more: a **BoE Sales** link in this page's site nav opens `boe.html` (see above), open to anyone signed in and scoped by the read policies. An old `?tab=boe` bookmark redirects there. |
